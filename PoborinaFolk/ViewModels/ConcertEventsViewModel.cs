...
namespace PoborinaFolk.ViewModels
{
    public class ConcertEventsViewModel: BaseViewModel
    {
        ...
        public ICommand SelectionCommandSunday => new Command(ShowInfoBandSunday);

        private void ShowInfoBandSunday()
        {
            if (selectedConcert != null)
            {
                var viewModel = new InfoBandPageViewModel(selectedConcert, sundayList);
                var infoBandPage = new InfoBandPage { BindingContext = viewModel };
        ...
        public ObservableCollection<Concerts> SundayList
        {
        ...
        ObservableCollection<Concerts> sundayList;
        private ObservableCollection<Concerts> GetSundayList()
        {
            return new ObservableCollection<Concerts>
            {
                //Todo replace with a webview
                new Concerts {ImageList="domingogroupo.png", NameBand="first Band Name", TimePlay="00h30", PlacePlay="Escenario Central", InfoBand="" +
                "Description of band\n " +
                "Lorem Ipsum is simply dummy text of the printing and typesetting industry.\n " +
                "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, " +
                "when an unknown printer took a galley of type and scrambled it to make a " +
                ...
                new Concerts {ImageList="domingogroupo1.png", NameBand="second Band Name", TimePlay="22h30", PlacePlay="Camping", InfoBand="" +
                " Lorem Ipsum is simply dummy text of the printing and typesetting industry. " +
                "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, " +
                "when an unknown printer took a galley of type and scrambled it to make a " +
                "type specimen book.\n\n It has survived not only five centuries, but also the " +
                ...
                "sites still in their infancy.Various versions have evolved over the years, sometimes by accident, " +
                "sometimes on purpose(injected humour and the like)."},
                new Concerts {ImageList="domingogroupo2.png", NameBand="third Band Name", TimePlay="20h30", PlacePlay="Escenario Latera", InfoBand="" +
                " Lorem Ipsum is simply dummy text of the printing and typesetting industry.\n " +
                "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, " +
                "when an unknown printer took a galley of type and scrambled it to make a " +
                "type specimen book.\n It has survived not only five centuries, but also the " +
                ...
                "sites still in their infancy.Various versions have evolved over the years, sometimes by accident, " +
                "sometimes on purpose(injected humour and the like)."},
                new Concerts {ImageList="domingogroupo3.png", NameBand="fourth Band Name", TimePlay="18h30", PlacePlay="Escenario Latera", InfoBand="" +
                " Lorem Ipsum is simply dummy text of the printing and typesetting industry.\n " +
                "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, " +
                "when an unknown printer took a galley of type and scrambled it to make a " +
                "type specimen book.\n It has survived not only five centuries, but also the " +
